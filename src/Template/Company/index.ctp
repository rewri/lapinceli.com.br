...
<div class="container padding-top-30 padding-bottom-60">
    <div class="row">
        <div class="col-md-12 col-xs-12 text-18" style="min-height: 500px; padding-top: 30px">
            ...
            <p style="margin-top: 30px; font-size: 24px">
            ...
            <p style="margin-top: 20px; font-size: 18px; font-weight: 600; display: none">
